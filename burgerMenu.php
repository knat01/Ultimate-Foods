...
<html lang="en">
<head>
	<title>Burgers - Ultimate Foods</title>
	<meta charset="UTF-8">
				...
				if ($row['type'] == "burger"){
					?>
						<div class = "col-lg-3 col-md-4 col-sm-6">
							<form method="post" action="burgerMenu.php?action=add&item_id= <?php echo $row['item_id']; ?>">
                                <div class="card">
...
<!--+-------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------+
    | name              | url                                                                                                                                                                   |
    +-------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------+
    | Beef Burger       | https://cdn.shopify.com/s/files/1/2181/5655/articles/57b208bbe0e5eba8a34505e4ea0a5846_1400x.jpg?v=1521138849                                                          |
    | Black Bean Burger | https://www.jessicagavin.com/wp-content/uploads/2018/05/vegan-black-bean-burgers-5-1200.jpg                                                                           |
    | Veggie Burger     | https://joyfoodsunshine.com/wp-content/uploads/2017/04/Baked-Sweet-Potato-Black-Bean-Veggie-Burgers-gluten-free-4.jpg                                                 |
    | Turkey Burger     | https://www.melskitchencafe.com/wp-content/uploads/2013/08/jalapeno-turkey-burgers5-720x720.jpg                                                                       |
    | Angus Burger      | https://burgermeister1.templatestudio.org/media/catalog/product/cache/1/image/1800x1440/9df78eab33525d08d6e5fb8d27136e95/a/n/angus-burger-38.jpg                      |
    | Salmon Burger     | https://www.kimscravings.com/wp-content/uploads/2017/06/DSC7540.jpg                                                                                                   |
    | Elk Burger        | https://bestmedicinenews.org/wp-content/uploads/ElkBurgerBestMed.jpg                                                                                                  |
    | Bison Burger      | https://www.thespruceeats.com/thmb/cwfqZmohJ_10bFFqIlCVSEVxuXs=/2533x2533/smart/filters:no_upscale()/bison-burger-4784208-hero-1-568060113b4941e2b0092ec5df2de4f6.jpg |
    +-------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------+-->